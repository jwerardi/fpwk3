...
function createHouse(color, xPos, yPos, zPos){
    ...
    var geometry = new THREE.CylinderGeometry( .5, 1, .75, 4 ,100,false, Math.PI/4);
...
function showTop(color, xPos, yPos, zPos){
    
    createHouse(color, xPos, yPos, zPos);
...
function showSide(color, xPos, yPos, zPos){
    createHouse(color, xPos, yPos, zPos);
    console.log("test");
...
function showFront(color, xPos, yPos, zPos){
    createHouse(color, xPos, yPos, zPos);
    let frontX = 150;
