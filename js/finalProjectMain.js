$( document ).ready(function() {
    ...
    $("#showTop").on('click', function(e){
        ...
        showTop(values.color, parseFloat(values.x), parseFloat(values.y), parseFloat(values.z));
    });
    $("#showSide").on('click', function(e){
        e.preventDefault();
        let values = getLightFormInputs();
        console.log("test front", values)
        showSide(values.color, parseFloat(values.x), parseFloat(values.y), parseFloat(values.z));
    });
    ...
    $("#showFront").on('click', function(e){
        ...
        let values = getLightFormInputs();
        console.log("test front", values)
        showFront(values.color, parseFloat(values.x), parseFloat(values.y), parseFloat(values.z));
    });
